...
void UWebSocketBase::SendLoginMsg(const FString& MatchName, const FString& MatchChildID,const TArray<FString>& Bikes)
{
	FString JsonStr;
	FString MN = MatchName;
	TSharedRef< TJsonWriter<TCHAR, TCondensedJsonPrintPolicy<TCHAR> > > JsonWriter = TJsonWriterFactory<TCHAR, TCondensedJsonPrintPolicy<TCHAR> >::Create(&JsonStr);
	JsonWriter->WriteObjectStart();
	JsonWriter->WriteValue(TEXT("command"), TEXT("login"));
	JsonWriter->WriteValue(TEXT("clienttype"), MN.Append(TEXT(",")).Append(MatchChildID));
	JsonWriter->WriteArrayStart(TEXT("Bikes"));
	for (FString Bikestr : Bikes) 
	{
		JsonWriter->WriteValue(Bikestr);
	}
...
void UWebSocketBase::SendMatchMsg(const FString& matchName,const FString & openid, const FString& bikename,const FString & RankIndex, const FString & kll, const FString & costtime, const FString & Avgspeed)
{
	FString JsonStr;
	TSharedRef< TJsonWriter<TCHAR, TCondensedJsonPrintPolicy<TCHAR> > > JsonWriter = TJsonWriterFactory<TCHAR, TCondensedJsonPrintPolicy<TCHAR> >::Create(&JsonStr);
	JsonWriter->WriteObjectStart();
	JsonWriter->WriteValue(TEXT("command"), TEXT("MatchData"));
	JsonWriter->WriteValue(TEXT("matchName"), matchName);
	JsonWriter->WriteValue(TEXT("openid"), openid);
	JsonWriter->WriteValue(TEXT("bikename"), bikename);
	JsonWriter->WriteValue(TEXT("rankindex"), RankIndex);
	JsonWriter->WriteValue(TEXT("kll"), kll);
	JsonWriter->WriteValue(TEXT("costtime"), costtime);
	JsonWriter->WriteValue(TEXT("avgspeed"), Avgspeed);
	JsonWriter->WriteObjectEnd();
...
void UWebSocketBase::SendMatchOverMsg(const FString & MatchName, const FString & MatchChildID)
{
	FString JsonStr;
	FString MN = MatchName;
	TSharedRef< TJsonWriter<TCHAR, TCondensedJsonPrintPolicy<TCHAR> > > JsonWriter = TJsonWriterFactory<TCHAR, TCondensedJsonPrintPolicy<TCHAR> >::Create(&JsonStr);
	JsonWriter->WriteObjectStart();
	JsonWriter->WriteValue(TEXT("command"), TEXT("MatchOver"));
	JsonWriter->WriteValue(TEXT("clienttype"), MN.Append(TEXT(",")).Append(MatchChildID));
...
void UWebSocketBase::SendUserExitMsg(const FString & openid, const FString & MachineName)
{
	FString JsonStr;
	TSharedRef< TJsonWriter<TCHAR, TCondensedJsonPrintPolicy<TCHAR> > > JsonWriter = TJsonWriterFactory<TCHAR, TCondensedJsonPrintPolicy<TCHAR> >::Create(&JsonStr);
	JsonWriter->WriteObjectStart();
	JsonWriter->WriteValue(TEXT("command"), TEXT("UserExit"));
	JsonWriter->WriteValue(TEXT("openid"), openid);
	JsonWriter->WriteValue(TEXT("bikename"), MachineName);
	JsonWriter->WriteObjectEnd();
